    ...
    <?php
      ...
      if(isset($_GET['cadastro'])){
          ...
          if($cadastro){
              ...
              echo "<p class='text-dange'>Erro ao realizar o cadastro!</p>";
          }
      }
      if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try{
          ...
          $stmt->execute([$email]);
          $usuario = $stmt->fetch(PDO::FETCH_ASSOC); //fetch trás os resultados que tenho no banco de dados (email e senha)
